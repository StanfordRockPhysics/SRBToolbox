function [mats,matf]=bornfilt(mate);
% [MATS,MATF]=BORNFILT(MATE);
%
% 5-50Hz : surface seismic
% 5-100Hz : VSP
% 100-1000Hz : well-to-well reflection, cross-well 
% 1-10kHz : log
%
% "Interactive" program to compute the filtered seismic image, given the true
% velocity image as the input. The Born approximation is used to filter the
...
f1max = 100.;f2max = 100.;f3max = 1000.;f4max = 4000.;f5max = 10000.;
f1min = 05.;f2min =   5.;f3min =  100.;f4min =  1000.;f5min =  1000.;
