function [Kreuss,rhoeff,Kvoigt,vpb,rhob,Kb,vpo,rhoo,Ko,vpg,rhog,Kg,gor]=batzle(method,sal,og,gg,gor,giib,giio,P,T,So,Sg)
% batzle - Batzle-Wang relations
%
%[Kreuss,rhoeff,Kvoigt,vpb,rhob,Kb,vpo,rhoo,Ko,vpg,rhog,Kg,gor]
%                             =batzle(method,sal,og,gg,gor,giib,giio,P,T,So,Sg)
% 
