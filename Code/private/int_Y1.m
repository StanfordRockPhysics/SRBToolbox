function Y1_integration=int_Y1(theta,phi,E)
I(1,:)=sin(theta).*cos(phi);
I(2,:)=sin(theta).*sin(phi);
I(3,:)=cos(theta);
Y1=sqrt(E(1,1).*I(1,:).*I(1,:) + E(1,2).*I(1,:).*I(2,:) + E(1,3).*I(1,:).*I(3,:) ...
    + E(2,1).*I(2,:).*I(1,:) + E(2,2).*I(2,:).*I(2,:) + E(2,3).*I(2,:).*I(3,:) ...
    + E(3,1).*I(3,:).*I(1,:) + E(3,2).*I(3,:).*I(2,:) + E(3,3).*I(3,:).*I(3,:));
Y1_integration = (1/(4*pi)).*sin(theta).*Y1.*2.*(-E(1,1).*I(1,:).*I(1,:) -E(1,2).*I(2,:).*I(1,:) - E(1,3).*I(3,:).*I(1,:));
