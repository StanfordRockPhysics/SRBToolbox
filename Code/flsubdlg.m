...
fr1yoffset=(QuestYOffset(3)+EditYOffset(2))/(2*FigHeight);
fr2yoffset=(QuestYOffset(9)+EditYOffset(8))/(2*FigHeight);
 
fr1handle = uicontrol(InputFig, ...
        'Units','normalized', ...
        'BackgroundColor',[0 0.0 0], ...
        'Position',[0.0 fr1yoffset+0.01 1 0.007], ...
        'Style','frame', ...
        'Tag','Frame1');
fr2handle = uicontrol(InputFig, ...
        'Units','normalized', ...
        'BackgroundColor',[0 0.0 0], ...
        'Position',[0.0 fr2yoffset+0.01 1 0.007], ...
        'Style','frame', ...
        'Tag','Frame1');
drawnow 
